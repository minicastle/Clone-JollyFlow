...
const Viewer = styled.img`
  ...
  opacity: 0;
  ${(props) => {
    return props.View === props.Numbering
      ? { animation: "ViewerFadeIn 0.5s linear", opacity: 1 }
      : { opacity: 0 };
  }}
...
const flake =
  "https://assets.website-files.com/63954148546a8e750c6f5e13/63976f46006e1a8a16bd8d7e_snowflake%2016-p-500.png";
const NameMain =
  "https://assets.website-files.com/63954148546a8e750c6f5e13/6395f5b72721b3e7107ca31e_JollyFlow%20Rustic.svg";
const NameSub =
  "https://assets.website-files.com/63954148546a8e750c6f5e13/6395f5b7dd443080bd62fd7c_JollyFlow%20Rustic-1.svg";
const card1 =
  "https://assets.website-files.com/63954148546a8e750c6f5e13/639621ce048e7c005a95d390_Calendar_min.webp";
const card2 =
  "https://assets.website-files.com/63954148546a8e750c6f5e13/639621ced716ff3d8388f854_Snowman_min.webp";
const card3 =
  "https://assets.website-files.com/63954148546a8e750c6f5e13/639621ceaa7b427f893656ba_Gift_min.webp";
const card4 =
  "https://assets.website-files.com/63954148546a8e750c6f5e13/639621ce9834c1c49cc3a4fa_Santa_min.webp";
const card5 =
  "https://assets.website-files.com/63954148546a8e750c6f5e13/639621ced716ffcdfc88f853_Cookie_min.webp";
  ...
  return (
    <Container>
      ...
      <Section ref={section3}>
        ...
        <MessageCard>
          ...
          <MessageDeco
            top={1}
            left={0}
            src="https://assets.website-files.com/63954148546a8e750c6f5e13/63954dd7fd907e616861154c_postcard-stamps.png"
            alt=""
          />
        </MessageCard>
        <HeaderButton
      ...
      <Section ref={section4}>
        ...
        <img
          src="https://assets.website-files.com/63954148546a8e750c6f5e13/63954a6aa689c7e1740da40d_santa%20with%20deers_angle%201.webp"
          alt=""
          style={{ width: "40%", maxWidth: "500px", marginBottom: "20px" }}
        />
        <TextLine>
        ...
        <Buttons>
          ...
          <Link
            to={`/Card/${card}?title=${title}&name=${name}&message=${message}`}
            style={{ textDecoration: "none" }}
          >
            <HeaderButton>COPY LINK</HeaderButton>
          </Link>
          <HeaderButton
            onClick={() => {
